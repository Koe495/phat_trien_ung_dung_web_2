document.addEventListener('DOMContentLoaded', () => {
    ...
    adjustNotchWidth('passwordHash', 'label-password', 'notch-password');

    /* Confirm password setup and validation */
    ...
    toggleConfirmBtn.addEventListener('click', () => {
        ...
        eyeIconConfirm.innerHTML = isPassword ? eyeOffPath : eyeOnPath;
        toggleConfirmBtn.setAttribute('aria-label', isPassword ? 'Ẩn mật khẩu' : 'Hiện mật khẩu');
    });
